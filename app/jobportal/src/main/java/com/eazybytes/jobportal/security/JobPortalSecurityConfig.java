...
public class JobPortalSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        var user1 = User.builder().username("suman")
                .password("$2a$10$JL1H/XNCLR00.ryfxtt3AeD3PlnenKZUs/tNFyNaXg71iPGRqcvIm")
                .roles("USER").build();
        var user2 = User.builder().username("admin")
                .password("$2a$10$892TeqXOo2fgUn4xBi3oPOD1T3MdYngHBba4BzV8xj82IT31sxrxe")
                .roles("ADMIN").build();
